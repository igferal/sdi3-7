...
public class Subscriber implements MessageListener {
	...
	public Subscriber(TopicConnection connection, Topic topic, User user,
			Long idTrip) throws Exception {
	...
	public void onMessage(Message m) {
		...
		try {
			if (msg.getLong("idUser") == user.getId()
					&& msg.getLong("idTrip") == idTrip
					&& msg.getBoolean("noParticipa")) {
				System.out.println("Ya no eres participante del viaje...");
			}
			...
			if (msg.getLong("idTrip") == idTrip) {
				System.out.println(msg.getString("login") + " dice: "
